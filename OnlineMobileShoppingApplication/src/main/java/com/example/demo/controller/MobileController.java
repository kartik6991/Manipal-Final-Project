...
public class MobileController {
	...
	public String deleteMobile(@PathVariable("id") String mobileId) throws MobileException {
	...
	public Mobile showMobileById(@PathVariable("id") String mobileId) throws MobileException {
